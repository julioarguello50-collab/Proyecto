Algoritmo ConsumoAgua
	Dimensionar consumo_agua(52,7), promedio_agua(52), max(52)
				...
				Si entrada=1 Entonces
					Repetir
						...
						Si semana_registro<=0 O semana_registro>51 Entonces
							Escribir 'Error: solo se permiten números mayores a 0 y menores o iguales a 52.'
							Escribir 'Presione una tecla para continuar'
							Leer c
							Limpiar Pantalla
							semana_registro <- 0
